...
public class TreeMapDemo {
	...
	public static void main(String[] args) {
		...
		students.put(new Student(101, "Ragavi", 67), "TY");
		students.put(new Student(102, "Rameela", 72), "FY");
		students.put(new Student(104, "Sagana", 71), "SY");
		students.put(new Student(103, "Ritiga", 87), "BE");
		...
		t.put(new Student(101, "Ragavi", 67), "TY");
		t.put(new Student(102, "Rameela", 72), "FY");
		t.put(new Student(104, "Sagana", 71), "SY");
		t.put(new Student(103, "Ritiga", 87), "BE");
